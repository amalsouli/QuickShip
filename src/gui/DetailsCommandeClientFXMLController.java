 ...
 * @author asus
 */
public class DetailsCommandeClientFXMLController implements Initializable {
    ...
    void setCommande(Commande c) {
        com = c;
        File imageFilec = new File("C:\\Users\\USER\\Downloads\\QuickShip\\src\\gui\\itineraire.png"); // chemin absolu vers l'image
        ...
        File imageFileEx = new File("C:\\Users\\USER\\Downloads\\QuickShip\\src\\gui\\express.png"); // chemin absolu vers l'image
        ...
        File imageFileo = new File("C:\\Users\\USER\\Downloads\\QuickShip\\src\\gui\\orange.png"); // chemin absolu vers l'image
        ...
        File imageFilep = new File("C:\\Users\\USER\\Downloads\\QuickShip\\src\\gui\\point.png"); // chemin absolu vers l'image
        Image pointI = new Image(imageFilep.toURI().toString());
        point.setImage(pointI);
        point1.setImage(pointI);
        File imageFileb = new File("C:\\Users\\USER\\Downloads\\QuickShip\\src\\gui\\bleuGris.png"); // chemin absolu vers l'image
        Image bleuI = new Image(imageFileb.toURI().toString());
        bleu.setImage(bleuI);
        File imageFilev = new File("C:\\Users\\USER\\Downloads\\QuickShip\\src\\gui\\vertGris.png"); // chemin absolu vers l'image
        ...
        point.setImage(pointI);
        point1.setImage(pointI);
        File imageFileb = new File("C:\\Users\\USER\\Downloads\\QuickShip\\src\\gui\\bleu.png"); // chemin absolu vers l'image
        Image bleuI = new Image(imageFileb.toURI().toString());
        bleu.setImage(bleuI);
        ...
        File imageFiler = new File("C:\\Users\\USER\\Downloads\\QuickShip\\src\\gui\\rouge.png"); // chemin absolu vers l'image
    ...
    public void start(Commande u) {
        ...
        try {
            ...
            Logger.getLogger(DetailsCommandeClientFXMLController.class.getName()).log(Level.SEVERE, null, ex);
        }
