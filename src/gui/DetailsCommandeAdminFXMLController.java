 ...
 * @author asus
 */
public class DetailsCommandeAdminFXMLController implements Initializable {
    ...
    public void start(Commande u) {
        ...
        try {
            ...
            Logger.getLogger(DetailsCommandeAdminFXMLController.class.getName()).log(Level.SEVERE, null, ex);
        }
